...
def init_bold_reg_wf(
    ...
    See Also
    --------
      * :py:func:`~fmriprep_rodents.workflows.bold.registration.init_bbreg_wf`
...
def init_bbreg_wf(use_bbr, bold2t1w_dof, bold2t1w_init, omp_nthreads, name="bbreg_wf"):
    ...
    Workflow Graph
        .. workflow ::
            ...
            from fmriprep_rodents.workflows.bold.registration import init_bbreg_wf
    ...
    t1w_brain
        Unused (see :py:func:`~fmriprep_rodents.workflows.bold.registration.init_fsl_bbr_wf`)
    t1w_dseg
        Unused (see :py:func:`~fmriprep_rodents.workflows.bold.registration.init_fsl_bbr_wf`)
...
def init_fsl_bbr_wf(
    use_bbr, bold2t1w_dof, bold2t1w_init, sloppy=False, name="fsl_bbr_wf"
):
    """
    ...
    It is a counterpart to :py:func:`~fmriprep_rodents.workflows.bold.registration.init_bbreg_wf`,
    ...
    Workflow Graph
        .. workflow ::
            ...
            from fmriprep_rodents.workflows.bold.registration import init_fsl_bbr_wf
    ...
    fsnative2t1w_xfm
        Unused (see :py:func:`~fmriprep_rodents.workflows.bold.registration.init_bbreg_wf`)
    subjects_dir
        Unused (see :py:func:`~fmriprep_rodents.workflows.bold.registration.init_bbreg_wf`)
    subject_id
        Unused (see :py:func:`~fmriprep_rodents.workflows.bold.registration.init_bbreg_wf`)
...
""".format(
    ...
    fsl_to_lta = pe.MapNode(
        LTAConvert(out_lta=True), iterfield=["in_fsl"], name="fsl_to_lta"
    )
